        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                  <input type='text' placeholder='Enter an option' value={optionOne} onChange={this.handleOptionOne}/>
                  <p>Or</p>  
                  <input type='text' placeholder='Enter an option' value={optionTwo} onChange={this.handleOptionTwo}/>
                  <button
                  onSubmit={this.handleSubmit}
                  disabled={optionOne === '' && optionTwo === ''}></button>
